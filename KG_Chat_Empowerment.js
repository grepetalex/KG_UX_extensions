...
(function () {
  ...
  const enterIconStrokeColor = "currentColor";
  const enterIcon = `
  <svg xmlns="${svgUrl}"
      width="${iconSize - 12}"
      height="${iconSize - 12}"
  ...
  const leaveIconStrokeColor = "currentColor";
  const leaveIcon = `
  <svg xmlns="${svgUrl}"
      width="${iconSize - 12}"
      height="${iconSize - 12}"
      viewBox="0 0 24 24"
      fill="none"
      stroke="${leaveIconStrokeColor}" stroke-width="${iconStrokeWidth}"
  ...
  const closeSVGStrokeColor = "currentColor";
  const clockSVG = `
  <svg xmlns="${svgUrl}"
       width="${iconSize - 12}"
       height="${iconSize - 12}"
  ...
  const iconSoundSilence = `
  <svg xmlns="${svgUrl}"
      width="${iconSize}"
      height="${iconSize}"
      viewBox="0 0 24 24"
      fill="none"
      stroke="${iconSilenceStrokeColor}"
      stroke-width="${iconStrokeWidth}"
      stroke-linecap="round" stroke-linejoin="round">
  ...
  const iconSoundVoice = `
  <svg xmlns="${svgUrl}"
      width="${iconSize}"
      height="${iconSize}"
      viewBox="0 0 24 24"
      fill="none"
      stroke="${iconVoiceStrokeColor}"
      stroke-width="${iconStrokeWidth}"
      stroke-linecap="round" stroke-linejoin="round">
    <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polygon>
  ...
  <svg xmlns="${svgUrl}"
      ...
      viewBox="0 0 24 24"
      fill="none"
      stroke="${iconModeEveryStrokeColor}"
      stroke-width="${iconStrokeWidth}"
      stroke-linecap="round" stroke-linejoin="round">
  ...
  const iconModeMention = `
  <svg xmlns="${svgUrl}"
      width="${iconSize}"
      height="${iconSize}"
      viewBox="0 0 24 24"
      fill="none"
      stroke="${iconModeMentionStrokeColor}"
      stroke-width="${iconStrokeWidth}"
      stroke-linecap="round" stroke-linejoin="round">
    <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
    <circle cx="12" cy="7" r="4"></circle>
  ...
  const iconRangeisOutStrokeColor = "currentColor";
  ...
  <svg xmlns="${svgUrl}"
      ...
      viewBox="0 0 24 24"
      fill="none"
      stroke="${iconRangeisOutStrokeColor}"
      stroke-width="${iconStrokeWidth}"
      stroke-linecap="round" stroke-linejoin="round" class="feather feather-slash">
    <circle cx="12" cy="12" r="10"></circle>
    <line x1="4.93" y1="4.93" x2="19.07" y2="19.07"></line>
  ...
  const iconUserlistCache = `
  <svg xmlns="${svgUrl}"
      width="${iconSize}"
      height="${iconSize}"
      viewBox="0 0 24 24"
      fill="none"
      stroke="${iconUserlistCacheStrokeColor}"
      stroke-width="${iconStrokeWidth}"
  ...
  const iconPersonalMessages = `
  <svg xmlns="${svgUrl}"
      width="${iconSize}"
      height="${iconSize}"
      viewBox="0 0 24 24"
      fill="none"
      stroke="${iconPersonalMessagesStrokeColor}"
      stroke-width="${iconStrokeWidth}"
  ...
  <svg xmlns="${svgUrl}"
      ...
      viewBox="0 0 24 24"
      fill="none"
      stroke="${iconChatLogsStrokeColor}"
      stroke-width="${iconStrokeWidth}"
  ...
  const iconMediaMessages = `
  <svg xmlns="${svgUrl}"
      width="${iconSize - 4}"
      height="${iconSize - 4}"
      viewBox="0 0 24 24"
      fill="none"
      stroke="${iconMediaMessagesStrokeColor}"
      stroke-width="${iconStrokeWidth}"
  ...
  const settingsIconStrokeColor = "rgb(255, 228, 196)";
  const settingsIcon = `
  <svg xmlns="${svgUrl}"
      width="${iconSize - 4}"
      height="${iconSize - 4}"
      viewBox="0 0 24 24"
      fill="none"
      stroke="${settingsIconStrokeColor}"
      stroke-width="${iconStrokeWidth}"
  ...
  const closeSVGStrokeColorY = "rgb(144, 238, 144)";
  const closeSVG = `
  <svg xmlns="${svgUrl}"
      width="${iconSize - 4}"
      height="${iconSize - 4}"
  ...
  <svg xmlns="${svgUrl}"
      ...
      viewBox="0 0 24 24"
      fill="none"
      stroke="${chevronsSVGStrokeColor}y"
      stroke-width="${iconStrokeWidth}"
...
`;
  ...
  */
  ...
  function createSettingsButton() {
    ...
    showSettingsButton.innerHTML = settingsIcon;
