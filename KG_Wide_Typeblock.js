...
(function () {
  ...
  function enterWideMode() {
    ...
    if (inputtext) {
      ...
      const helpText = `
        [Помощь:] Ctrl + наведите на поле ввода.<br>
        [Выход:] ESC или двойной клик строке ввода.<br>
        ...
        [Режим отображения текста:] двойной клик по блоку (построчно или полностью).<br>
        [Колличество строк:] прокрутите колесо мыши вверх/вниз на блоке.<br>
        [Размер шрифта:] Ctrl + колесо мыши вверх/вниз на блоке.<br>
        [Кастомные настройки:] (ПКМ) по полю ввода (Запомнить/Забыть).<br>
      `;
